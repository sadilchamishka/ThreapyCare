...
def document():
    ...
    document.merge(name=str(content['name']),ndis=str(content['ndis']),sos=str(content['sos']),duration=str(content['duration']/7),start=content['start'],end=content['end'],today=content['today'],policy=content['policy'])
